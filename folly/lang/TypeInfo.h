...
/// Returns &typeid(T) if RTTI is available, nullptr otherwise, for the static type T.
///
/// @return Pointer to the type_info of T, or nullptr when RTTI is unavailable
template <typename T>
...
/// Returns &typeid(t) if RTTI is available, nullptr otherwise, for the dynamic type of t.
///
/// @param t Object whose dynamic type is queried
/// @return Pointer to the type_info of t, or nullptr when RTTI is unavailable
template <typename T>
FOLLY_ERASE constexpr std::type_info const* type_info_of(
