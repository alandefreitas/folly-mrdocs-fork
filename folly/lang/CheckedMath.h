...
///
/// @param result Out-param receiving the sum on success
/// @param a First addend
/// @param b Second addend
/// @return True on success; false on overflow, in which case *result is set to zero
template <typename T>
  requires std::is_integral_v<T>
...
///
/// @param result Out-param receiving the quotient on success
/// @param dividend Value to be divided
/// @param divisor Value to divide by
/// @return True on success; false when divisor is zero, in which case *result is set to zero
template <typename T>
...
///
/// @param result Out-param receiving the remainder on success
/// @param dividend Value to be divided
/// @param divisor Value to divide by
/// @return True on success; false when divisor is zero, in which case *result is set to zero
template <typename T>
...
///
/// @param result Out-param receiving the product on success
...
///
/// @param result Out-param receiving base * mul + add on success
/// @param base Value to be multiplied
/// @param mul Multiplier
/// @param add Value added to the product
/// @return True on success; false on overflow, in which case *result is set to zero
template <typename T>
  requires std::is_unsigned_v<T>
...
///
/// @param result Out-param receiving the advanced pointer on success
/// @param a Base pointer
/// @param b Number of elements to advance by
/// @return True on success; false on overflow, in which case *result is set to zero
