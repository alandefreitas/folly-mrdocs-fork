...
struct to_ascii_alphabet {
  ...
  /// Translate a single digit value to '0'-'9', 'a'-'z' or 'A'-'Z'.
  ///
  /// @param b Digit value, assumed less than the base
  /// @return The ASCII character for the digit
...
/// @return The number of base-Base digits
template <uint64_t Base>
...
///
/// @param outb Start of the output buffer
/// @param oute End of the output buffer
...
///
/// @param out Fixed-size output buffer to write into
/// @param v Value to encode
/// @return The number of bytes written
template <uint64_t Base, typename Alphabet, size_t N>
...
/// Write the base-Base digits of v in lowercase into [outb, oute).
///
/// @param outb Start of the output buffer
/// @param oute End of the output buffer
/// @param v Value to encode
...
/// Write the base-Base digits of v in lowercase into a fixed-size buffer.
///
/// @param out Fixed-size output buffer to write into
/// @param v Value to encode
/// @return The number of bytes written
...
/// Write the base-Base digits of v in uppercase into [outb, oute).
///
/// @param outb Start of the output buffer
/// @param oute End of the output buffer
/// @param v Value to encode
...
/// Write the base-Base digits of v in uppercase into a fixed-size buffer.
///
/// @param out Fixed-size output buffer to write into
/// @param v Value to encode
/// @return The number of bytes written
