...
/// An Unaligned<T> variant whose loads and stores can have address sanitizer
/// disabled on demand.
template <class T>
...
struct Bits {
  /// The unsigned integral type backing each block element.
   ...
   * @return The index of the block that holds the bit.
   */
   ...
   *
   * @param bit The bit position.
   * @return The bit's offset within its block.
   */
   ...
   * @return The number of blocks needed to hold that many bits.
   */
   ...
   * Set the given bit.
   *
   * @param p Pointer to the first block of the array.
   ...
   *
   * @param p Pointer to the first block of the array.
   * @param bitStart The bit position of the first bit to set.
   * @param count The number of contiguous bits to set.
   * @param value The value whose low `count` bits are written.
   */
   ...
   *
   * @param p Pointer to the first block of the array.
   * @param bitStart The bit position of the first bit to read.
   * @param count The number of contiguous bits to read.
   * @return The extracted bits, right-aligned in the returned value.
   */
   ...
   *
   * @param begin Pointer to the first block of the range.
   * @param end Pointer past the last block of the range.
   * @return The total number of set bits in the range.
   */
