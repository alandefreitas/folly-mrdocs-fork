...
class badge {
 public:
  ...
  ///
  /// @param b The any_badge permitting this holder
  /* implicit */ constexpr badge(any_badge<Holder> b) noexcept {}
...
class any_badge {
 public:
  /// Construct from a single holder's badge, lifting it into this any_badge.
  ///
  /// @param b The individual holder's badge
  template <
      typename Holder,
      typename = std::enable_if_t<folly::IsOneOf<Holder, Holders...>::value>>
  /* implicit */ constexpr any_badge(badge<Holder> b) noexcept {}
...
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=104008
  ...
  /// Lift a subset any_badge into this superset any_badge.
  ///
  /// @param b The any_badge over a subset of holders
  template <typename... OtherHolders>
  /* implicit */ constexpr any_badge(any_badge<OtherHolders...> b) noexcept {}
#else
  /// Lift a subset any_badge into this superset any_badge.
  ///
  /// @param b The any_badge over a subset of holders
