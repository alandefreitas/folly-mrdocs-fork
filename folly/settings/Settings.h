 ...
 *
 * @param _project  Project identifier of the setting.
 * @param _name  Setting name within the project.
 * @param _Type  Setting value type.
 * @param _def  Default value for the setting.
 * @param _mut  Mutability of the setting.
 * @param _cli  Determines if the setting can be set from the command line.
 ...
 *
 * \param settingName Fully qualified name of the setting to look up.
...
class Snapshot final : public detail::SnapshotBase {
 public:
   ...
   *
   * \param setting The global setting wrapper to bind to this snapshot.
   * \returns A snapshot-local wrapper for the setting.
   */
   ...
   *
   * @param settingName Name of the setting to reset.
   ...
   *
   * \param func Callback invoked with the visitor info for each setting.
   */
  void forEachSetting(
