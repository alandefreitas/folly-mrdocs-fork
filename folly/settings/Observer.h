...
/// Gets a folly::observer::Observer<T> for a given setting. For example:
...
///
/// \param setting The setting wrapper to observe.
/// \returns An observer that reflects the setting's current value.
