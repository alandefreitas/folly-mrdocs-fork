 ...
 *
 * \param projects The set of setting projects whose immutables to freeze.
 */
 ...
 *
 * \param project The setting project to query.
...
struct FrozenSettingProjects {
  /// Constructs a snapshot from a set of frozen project names.
  ///
  /// \param projects The set of frozen setting project names.
  explicit FrozenSettingProjects(F14FastSet<std::string> projects);

  /// Returns whether the given project is in the frozen set.
  ///
  /// \param project The project name to look up.
  /// \returns true if the project is frozen, false otherwise.
