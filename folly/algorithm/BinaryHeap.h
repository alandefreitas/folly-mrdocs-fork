 ...
 * top is modified.
 *
 * \param first Iterator to the first element of the heap range.
 * \param last Iterator past the last element of the heap range.
 * \param comp Comparator defining the heap ordering.
 */
...
/// Companion to std::push/pop_heap(). Restores the heap property if the heap's
/// top is modified, using std::less as the comparator.
///
/// \param first Iterator to the first element of the heap range.
/// \param last Iterator past the last element of the heap range.
