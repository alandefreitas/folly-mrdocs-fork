...
class FiberImpl {
 ...
 public:
  /// Constructs a fiber that runs the given function on the provided stack.
  /// @param func Function to execute when the fiber is activated.
  /// @param stackLimit Pointer to the bottom of the fiber's stack memory.
  /// @param stackSize Size in bytes of the fiber's stack.
  FiberImpl(
  ...
  /// Resumes execution of the fiber, transferring control into its context.
  void activate() {
  ...
  /// Suspends the fiber and returns control to the main context.
  void deactivate() {
    auto transfer =
  ...
  /// Returns the current stack pointer of the fiber, or null if unavailable.
  /// @returns Pointer to the fiber's saved frame base, or null on unsupported platforms.
