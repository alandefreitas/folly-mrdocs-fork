 ...
 *
 * @param func Function to execute under the new async-stack-root.
 * @param callerFrame Frame to stitch the new root onto, or null for none.
 * @returns The async result of invoking `func`.
 */
template <typename F>
 ...
 * stacks.
 *
 * @param func Synchronous function to run on the main thread context.
