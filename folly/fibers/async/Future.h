 ...
 *
 * @param semi The semi-future to block on.
 * @returns The value produced by the semi-future, wrapped as Async.
 */
template <typename T>
...
/// Blocks on a Future and returns its value as an Async result.
/// @param fut The future to block on.
/// @returns The value produced by the future, wrapped as Async.
template <typename T>
