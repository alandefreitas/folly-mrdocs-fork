...
class BatchDispatcher {
 public:
  ...
  /// @param executor Executor used to schedule the batched dispatch task.
  /// @param dispatchFunc Function invoked with the collected batch of values.
  ...
  /// @param value The value to add to the batch.
  /// @returns A future for the result computed by the dispatch function.
