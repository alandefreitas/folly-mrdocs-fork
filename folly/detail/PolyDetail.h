...
///
/// \param that The PolyRoot holding the object.
/// \returns A reference to the stored object cast to type T.
...
///
/// \param that The PolyRoot holding the object.
/// \returns A const reference to the stored object cast to type T.
template <class T, class I>
