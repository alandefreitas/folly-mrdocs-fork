...
class reproducible_accumulator {
 ...
 public:
  ...
  /// Copy-constructs an accumulator from another.
  ///
  /// Cross-type conversion is intentionally omitted: the bin structures differ
  /// across ftype, so conversion must go through .value() to make the lossy
  /// collapse explicit.
  ///
  /// \param other The accumulator to copy.
  reproducible_accumulator(reproducible_accumulator const& other) = default;

  /// Move-constructs an accumulator from another.
  ///
  /// \param other The accumulator to move from.
  reproducible_accumulator(reproducible_accumulator&& other) = default;

  /// Copy-assigns from another accumulator.
  ///
  /// \param other The accumulator to copy.
  ...
  /// Move-assigns from another accumulator.
  ///
  /// \param other The accumulator to move from.
  /// \returns A reference to this accumulator.
  ...
  ///
  /// \param other The accumulator to add.
  /// \returns A reference to this accumulator.
  reproducible_accumulator& operator+=(reproducible_accumulator const& other) {
  ...
  ///
  /// \param other The accumulator to subtract.
  /// \returns A reference to this accumulator.
  reproducible_accumulator& operator-=(reproducible_accumulator other) {
  ...
  ///
  /// \param other The accumulator to compare against.
  /// \returns Whether the two accumulators are equal.
  ...
  ///
  /// \param lhs The left-hand accumulator.
  /// \param rhs The right-hand accumulator.
  ...
  ///
  /// \returns The negation of this accumulator.
  ...
  ///
  /// \returns The native floating-point value of this accumulator.
  ...
  ///
  /// \param n The number of values accumulated.
  /// \param max_abs_val The maximum absolute value among the accumulated values.
  /// \param binned_sum The accumulated sum.
  /// \returns An upper bound on the summation error.
  ...
  ///
  /// \param first The beginning of the range to add.
  ...
  ///
  /// \param range The range of arithmetic values to add.
  ...
  ///
  /// \param mav The maximum absolute value of subsequent deposits.
  template <typename T>
  ...
  ///
  /// \returns The maximum number of unsafe_add() deposits between renorms.
...
struct fmt::formatter<folly::reproducible_accumulator<ftype, Fold>>
  ...
  ///
  /// \param rfa The accumulator to format.
