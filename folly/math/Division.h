...
/// Facebook Folly open-source C++ library.
namespace folly {
...
struct uint_division_result {
  ...
  Word quotient; ///< The quotient of the division.
  Word remainder; ///< The remainder of the division.
};
...
class uint_divisor {
 ...
 public:
  ...
  class calc : private calc_base {
   ...
   public:
    ...
    ///
    /// \param divisor The fixed divisor. A zero divisor is permitted.
    ...
    /// \param divisor The divisor this calculator was constructed with.
    /// \returns The quotient and remainder of `dividend / divisor`.
    ...
    /// the behavior is undefined.
    ///
    /// \param dividend The value to test.
    /// \param divisor The divisor this calculator was constructed with.
    /// \returns Whether `divisor` divides `dividend`.
 ...
 public:
  ...
  ///
  /// \param dividend The value to test.
  /// \returns Whether this divisor divides `dividend`.
...
/// a reference to it.
///
/// \param dividend The value to replace with the quotient.
/// \param divisor The divisor.
/// \returns A reference to `dividend`.
template <typename Word>
...
/// a reference to it.
///
/// \param dividend The value to replace with the remainder.
/// \param divisor The divisor.
/// \returns A reference to `dividend`.
template <typename Word>
constexpr Word& operator%=(Word& dividend, uint_divisor<Word> const& divisor) {
