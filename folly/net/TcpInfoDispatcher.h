...
class TcpInfoDispatcher {
 public:
  /// Returns the singleton TcpInfoDispatcher instance.
  ///
  /// \returns The default TcpInfoDispatcher instance.
 ...
 protected:
  /// Default-constructs a TcpInfoDispatcher.
  TcpInfoDispatcher() = default;
  /// Destroys the TcpInfoDispatcher.
...
class TcpInfoDispatcherContainer {
 public:
   ...
   *
   * @return The active TcpInfoDispatcher.
   */
   ...
   * returns empty ptr.
   *
   * @return The override TcpInfoDispatcher, or an empty ptr if none is set.
   */
