...
/// Fundamental utilities and vocabulary types for Folly.
namespace folly {
...
/// Deleter and unique_ptr aliases for an GENERAL_NAME object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(GeneralName, GENERAL_NAME, GENERAL_NAME_free);
/// Deleter and unique_ptr aliases for an GENERAL_NAMES object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(
    GeneralNames, GENERAL_NAMES, GENERAL_NAMES_free);
/// Deleter and unique_ptr aliases for an ACCESS_DESCRIPTION object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(
    AccessDescription, ACCESS_DESCRIPTION, ACCESS_DESCRIPTION_free);
/// Deleter and unique_ptr aliases for an AUTHORITY_INFO_ACCESS object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(
    AuthorityInfoAccess, AUTHORITY_INFO_ACCESS, AUTHORITY_INFO_ACCESS_free);
/// Deleter and unique_ptr aliases for an DIST_POINT_NAME object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(
    DistPointName, DIST_POINT_NAME, DIST_POINT_NAME_free);
/// Deleter and unique_ptr aliases for an DIST_POINT object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(DistPoint, DIST_POINT, DIST_POINT_free);
/// Deleter and unique_ptr aliases for an CRL_DIST_POINTS object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(
    CrlDistPoints, CRL_DIST_POINTS, CRL_DIST_POINTS_free);
/// Deleter and unique_ptr aliases for an X509_CRL object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(X509Crl, X509_CRL, X509_CRL_free);
/// Deleter and unique_ptr aliases for an X509_NAME object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(X509Name, X509_NAME, X509_NAME_free);
/// Deleter and unique_ptr aliases for an X509_REQ object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(X509Req, X509_REQ, X509_REQ_free);
/// Deleter and unique_ptr aliases for an X509_REVOKED object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(X509Revoked, X509_REVOKED, X509_REVOKED_free);

// EVP
/// Deleter and unique_ptr aliases for an EVP_PKEY object.
/// \implementationdefined
...
/// Deleter and unique_ptr aliases for an EVP_ENCODE_CTX object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(
    EvpEncodeCtx, EVP_ENCODE_CTX, EVP_ENCODE_CTX_free);

/// Deleter and unique_ptr aliases for an EVP_PKEY_CTX object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(EvpPkeyCtx, EVP_PKEY_CTX, EVP_PKEY_CTX_free);

/// Deleter and unique_ptr aliases for an EVP_MD_CTX object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(EvpMdCtx, EVP_MD_CTX, EVP_MD_CTX_free);
/// Deleter and unique_ptr aliases for an EVP_CIPHER_CTX object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(
    EvpCipherCtx, EVP_CIPHER_CTX, EVP_CIPHER_CTX_free);

// HMAC
/// Deleter and unique_ptr aliases for an HMAC_CTX object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(HmacCtx, HMAC_CTX, HMAC_CTX_free);

// BIO
/// Deleter and unique_ptr aliases for an BIO_METHOD object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(BioMethod, BIO_METHOD, BIO_meth_free);
/// Deleter and unique_ptr aliases for an BIO object.
/// \implementationdefined
...
// RSA and EC
/// Deleter and unique_ptr aliases for an RSA object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(Rsa, RSA, RSA_free);
#ifndef OPENSSL_NO_EC
/// Deleter and unique_ptr aliases for an EC_KEY object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(EcKey, EC_KEY, EC_KEY_free);
/// Deleter and unique_ptr aliases for an EC_GROUP object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(EcGroup, EC_GROUP, EC_GROUP_free);
/// Deleter and unique_ptr aliases for an EC_POINT object.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_PTR_TYPE(EcPoint, EC_POINT, EC_POINT_free);
/// Deleter and unique_ptr aliases for an ECDSA_SIG object.
/// \implementationdefined
...
/// Owning and borrowing STACK_OF(X509_NAME) unique_ptr aliases.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_STACK_PTR_TYPE(X509Name, X509_NAME);
/// Owning and borrowing STACK_OF(X509) unique_ptr aliases.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_STACK_PTR_TYPE(X509, X509);
/// Owning and borrowing STACK_OF(X509_EXTENSION) unique_ptr aliases.
/// \implementationdefined
FOLLY_SSL_DETAIL_DEFINE_STACK_PTR_TYPE(X509Extension, X509_EXTENSION);
/// Owning and borrowing STACK_OF(ASN1_OBJECT) unique_ptr aliases.
/// \implementationdefined
