...
class EventBaseManager {
 public:
  ...
  /// Constructs a manager with the given EventBase options and observer.
  ///
  /// \param options The options applied to EventBases created by this manager.
  /// \param observer The observer attached to EventBases created by this manager.
  ...
  /// Constructs a manager with the given observer.
  ///
  /// \param observer The observer attached to EventBases created by this manager.
   ...
   *
   * \returns The global EventBaseManager singleton.
   */
   ...
   *
   * \returns The EventBase for the current thread.
   */
   ...
   *
   * \returns The EventBase for the current thread, or nullptr if none exists.
   */
   ...
   *
   * \param eventBase The EventBase to use for this thread.
   * \param takeOwnership Whether the manager should own and destroy eventBase.
   */
