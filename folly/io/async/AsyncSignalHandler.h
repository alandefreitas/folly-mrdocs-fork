...
class AsyncSignalHandler {
 public:
   ...
   *
   * \param eventBase The EventBase this handler attaches to.
   */
   ...
   *
   * \returns The EventBase this handler is attached to.
   */
   ...
   *
   * \param signum The signal number to register for.
   */
...
class CallbackAsyncSignalHandler : public AsyncSignalHandler {
 public:
  /**
   * Construct a CallbackAsyncSignalHandler that forwards to a callback.
   *
   * \param evb The EventBase this handler attaches to.
   * \param cb The callback invoked when a registered signal is received.
   */
  CallbackAsyncSignalHandler(folly::EventBase* evb, Callback&& cb)
      : AsyncSignalHandler{evb}, cb_{std::forward<Callback>(cb)} {}

  /**
   * Forward the received signal to the stored callback.
   *
   * \param signum The signal number that was received.
   */
