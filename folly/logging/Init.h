 ...
 *
 * @param configString A logging configuration string to apply.
 */
void initLogging(folly::StringPiece configString = "");
/// Initializes the logging library from several configuration strings.
///
/// \param configStrings The logging configuration strings to apply in order.
...
/// Initializes logging from several strings, exiting the program on error.
///
/// \param configStrings The logging configuration strings to apply in order.
 ...
 *
 * @returns The base logging configuration string, or null for none.
 */
 ...
 * program.
 *
 * @param config The base logging configuration string to return.
 */
