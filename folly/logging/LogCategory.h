...
class LogCategory {
 public:
   ...
   *
   * \param db The LoggerDB that owns this root category.
   */
   ...
   *
   * \param name The canonical name of the new log category.
   * \param parent The parent category in the category hierarchy.
   */
   ...
   *
   * \returns The name of this log category.
   */
   ...
   *
   * \returns The log level for this category.
   */
   ...
   *
   * \returns A pair of the log level and whether inheritance is enabled.
   */
   ...
   * parents.
   *
   * \returns The effective log level for this category.
   */
   ...
   * memory ordering.
   *
   * \returns The effective log level, loaded with relaxed memory ordering.
   */
   ...
   *
   * \param level The log level to check against the effective level.
   * \returns True if a message at this level would be processed.
   */
   ...
   *
   * \param level The new log level for this category.
   * \param inherit Whether to inherit the parent category's effective level.
   */
   ...
   *
   * \param level The minimum level of messages to propagate to the parent.
   */
   ...
   * parent category
   *
   * \returns The minimum level of messages propagated to the parent category.
   */
   ...
   *
   * \returns The LoggerDB that this LogCategory belongs to.
   */
   ...
   *
   * \param handler The LogHandler to attach to this category.
   */
   ...
   *
   * \returns The list of LogHandlers attached to this category.
   */
   ...
   *
   * \param handlers The new list of LogHandlers to attach to this category.
   */
   ...
   *
   * \param handlerMap Map of old handler to new handler used for replacement.
   */
  void updateHandlers(
   ...
   *
   * \param message The log message to admit into the hierarchy.
   * \param skipAbortOnFatal If true, do not std::abort() on a fatal message.
   */
  void admitMessage(
   ...
   *
   * \param levelPtr Pointer to the atomic level value to keep updated.
   */
