 ...
 *
 * @param str The string to append the object information to.
 * @param arg A pointer to the object to describe.
 */
 ...
 * @param arg The object to append.
 */
template <typename Arg>
 ...
 *
 * @param result The string to append to.
 * @param arg1 The first object to append.
 * @param remainder The remaining objects to append.
 */
 ...
 *
 * @param result The string to append to (left unchanged).
 */
