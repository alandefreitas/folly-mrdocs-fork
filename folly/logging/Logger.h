 ...
 *
 * @param logger The logger identifying the log category.
 * @param level The unqualified `folly::LogLevel` name.
 */
 ...
 * @param logger The logger identifying the log category.
 * @param level The unqualified `folly::LogLevel` name.
 * @param fmt The `fmt::format` format string.
 ...
 *
 * @param logger The logger identifying the log category.
 * @param level A qualified `folly::LogLevel` value or variable.
 * @param filename The source filename to record.
 * @param linenumber The source line number to record.
 * @param functionName The function name to record.
 */
 ...
 * @param level A qualified `folly::LogLevel` value or variable.
 * @param filename The source filename to record.
 * @param line The source line number to record.
 * @param functionName The function name to record.
 * @param type The `LogStreamProcessor` append or format mode.
 */
...
class Logger {
 public:
   ...
   * already exist.
   *
   * @param name The log category name.
   */
   ...
   *
   * @param cat The log category this logger refers to.
   */
   ...
   *
   * @param db The LoggerDB to resolve the category against.
   * @param name The log category name.
   */
   ...
   *
   * @returns The log category this logger refers to.
   */
