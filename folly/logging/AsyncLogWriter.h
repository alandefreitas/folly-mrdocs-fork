...
class AsyncLogWriter : public LogWriter {
 public:
   ...
   *
   * @param size The maximum number of bytes to buffer.
   */
   ...
   *
   * @returns The maximum number of bytes buffered before messages are dropped.
   */
   ...
   *
   * @param callback The callback to invoke when messages are discarded.
   */
