...
/// A drop-in replacement for std::vector with a more efficient growth strategy.
...
class fbvector {
 ...
 public:
  ...
  /// A mutable iterator over the elements.
  using iterator = T*;
  ...
  /// The allocator type used to manage storage.
...
#undef FOLLY_FBV_OP
 ...
 public:
  ...
  /// Construct an empty vector using a specified allocator.
  ///
  /// \param a The allocator to use.
  explicit fbvector(const Allocator& a) : impl_(a) {}

  /// Construct a vector with n value-initialized elements.
  ///
  ...
  /// Construct a vector with n copies of a value.
  ///
  /// \param n The number of elements.
  ...
  /// Construct a vector from an iterator range.
  ///
  ...
  /// Copy-construct a vector from another.
  ///
  ...
  /// Move-construct a vector from another.
  ///
  /// \param other The vector to move from.
  fbvector(fbvector&& other) noexcept : impl_(std::move(other.impl_)) {}

  /// Copy-construct a vector using a specified allocator.
  ///
  /// \param other The vector to copy from.
  /// \param a The allocator to use.
  ...
  /// Move-construct a vector using a specified allocator.
  ///
  /// \param other The vector to move from.
  /// \param a The allocator to use.
  ...
  /// Destroy the vector and free its storage.
  ~fbvector() = default; // the cleanup occurs in impl_

  /// Copy-assign the contents of another vector.
  ///
  /// \param other The vector to copy from.
  ...
  /// Move-assign the contents of another vector.
  ///
  /// \param other The vector to move from.
  /// \returns A reference to this vector.
  ...
  ///
  /// \param il The initializer list of elements to assign.
  /// \returns A reference to this vector.
  ...
  /// Replace the contents with the elements of an iterator range.
  ///
  /// \param first Iterator to the beginning of the range to assign.
  /// \param last Iterator past the end of the range to assign.
  template <
      class It,
      class Category = typename std::iterator_traits<It>::iterator_category>
  ...
  /// Return a copy of the vector's allocator.
  ///
 ...
 public:
  ...
  ///
  /// \returns A const reverse iterator to the reverse beginning.
  const_reverse_iterator rbegin() const noexcept {
    return const_reverse_iterator(end());
  }
  /// Return a reverse iterator to the element before the first.
  ///
  /// \returns A reverse iterator to the reverse end.
  reverse_iterator rend() noexcept { return reverse_iterator(begin()); }
  /// Return a const reverse iterator to the element before the first.
  ///
  /// \returns A const reverse iterator to the reverse end.
 ...
 public:
  ...
  /// Resize the vector, value-initializing any new elements.
  ///
  ...
  /// Resize the vector, filling new elements with a value.
  ///
  /// \param n The new size.
  /// \param t The value used to fill any newly added elements.
  template <class U = T>
 ...
 public:
  ...
  ///
  /// \param n The index of the element to access.
  /// \returns A const reference to the element at index n.
 ...
 public:
  ...
  /// Return a const pointer to the underlying element storage.
  ///
 ...
 public:
  ...
  /// Append an element to the end of the vector by copying it.
  ///
  ...
  /// Append an element to the end of the vector by moving it.
  ///
 ...
 public:
  ...
  /// Erase the elements in a range from the vector.
  ///
  /// \param first Iterator to the first element to erase.
  /// \param last Iterator past the last element to erase.
  /// \returns An iterator to the element following the erased range.
 ...
 public:
  /// Construct an element in place before a position.
  ///
  /// \param cpos The position to insert before.
  /// \param args The arguments forwarded to the element constructor.
  /// \returns An iterator to the constructed element.
  template <class... Args>
  ...
  /// Insert an element before a position by copying it.
  ///
  /// \param cpos The position to insert before.
  /// \param value The value to copy into the vector.
  ...
  /// Insert an element before a position by moving it.
  ///
  /// \param cpos The position to insert before.
  /// \param value The value to move into the vector.
  /// \returns An iterator to the inserted element.
  ...
  /// Insert the elements of an iterator range before a position.
  ///
  /// \param cpos The position to insert before.
  /// \param first Iterator to the beginning of the range to insert.
  /// \param last Iterator past the end of the range to insert.
  /// \returns An iterator to the first inserted element.
  template <
      class It,
      class Category = typename std::iterator_traits<It>::iterator_category>
 ...
 public:
  ...
  /// \returns true if the vectors have equal size and equal elements.
  ...
  /// Compare two vectors for less-than order.
  ///
  /// \param other The vector to compare against.
  /// \returns true if this vector is lexicographically less than other.
  bool operator<(const fbvector& other) const {
    return std::lexicographical_compare(
        begin(), end(), other.begin(), other.end());
  }

  /// Compare two vectors for greater-than order.
  ///
  /// \param other The vector to compare against.
  /// \returns true if this vector is lexicographically greater than other.
  bool operator>(const fbvector& other) const { return other < *this; }

  /// Compare two vectors for less-than-or-equal order.
  ///
  /// \param other The vector to compare against.
  /// \returns true if this vector is not lexicographically greater than other.
  bool operator<=(const fbvector& other) const { return !(*this > other); }

  /// Compare two vectors for greater-than-or-equal order.
  ///
  /// \param other The vector to compare against.
  /// \returns true if this vector is not lexicographically less than other.
  bool operator>=(const fbvector& other) const { return !(*this < other); }
  ...
  // friends
 private:
  /// Grants the free relinquish function access to the vector internals.
  ///
  /// \param v The vector to relinquish storage from.
  /// \returns A pointer to the released data.
  template <class _T, class _A>
  friend _T* relinquish(fbvector<_T, _A>& v);

  /// Grants the free attach function access to the vector internals.
  ///
  /// \param v The vector to attach storage to; must be empty.
  /// \param data Pointer to the external storage.
  /// \param sz The number of constructed elements in the storage.
  /// \param cap The capacity of the storage.
  template <class _T, class _A>
  friend void attach(fbvector<_T, _A>& v, _T* data, size_t sz, size_t cap);
...
/// Release ownership of the vector's storage to the caller.
///
/// \param v The vector to relinquish storage from.
/// \returns A pointer to the released data.
template <class T, class A>
...
/// Deduction guide for fbvector from an iterator range.
template <
    class InputIt,
    class Allocator =
...
/// Erase all elements equal to a value from the vector.
///
...
/// Erase all elements satisfying a predicate from the vector.
///
/// \param v The vector to erase elements from.
/// \param predicate The predicate selecting elements to erase.
