...
///
/// \param begin The first value of the interval, cast to the type of `end`.
/// \param end The past-the-end value of the interval.
/// \returns An iota_view over the half-open interval [begin, end).
template <
...
///
/// \param end The past-the-end value of the interval.
/// \returns An iota_view over the half-open interval [0, end).
