...
/// Merge two sorted ranges using a comparator, preferring the first range on ties.
///
/// \param first1 Iterator to the beginning of the first sorted range.
/// \param last1 Iterator past the end of the first sorted range.
/// \param first2 Iterator to the beginning of the second sorted range.
/// \param last2 Iterator past the end of the second sorted range.
/// \param d_first Output iterator receiving the merged elements.
/// \param comp Comparator returning true when its first argument orders before its second.
/// \returns An output iterator past the last element written.
...
/// Merge two sorted ranges, preferring elements from the first range on ties.
///
/// \param first1 Iterator to the beginning of the first sorted range.
/// \param last1 Iterator past the end of the first sorted range.
/// \param first2 Iterator to the beginning of the second sorted range.
