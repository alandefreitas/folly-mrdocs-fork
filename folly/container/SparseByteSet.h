...
class SparseByteSet {
 public:
   ...
   *  O(1), non-amortized.
   *
   *  \param i The byte value to insert.
   *  \returns True if `i` was newly inserted, false if it was already present.
   */
   ...
   *  O(1), non-amortized.
   *
   *  \param i The byte value to remove.
   *  \returns True if `i` was present and removed, false otherwise.
   */
   ...
   *  O(1), non-amortized.
   *
   *  \param i The byte value to test for membership.
   *  \returns True if `i` is in the set, false otherwise.
   */
   ...
   *  O(1), non-amortized.
   *
   *  \returns The number of byte values currently in the set.
   */
