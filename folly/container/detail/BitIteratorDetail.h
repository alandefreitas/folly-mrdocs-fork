...
class BitReference {
 public:
  ...
  ///
  /// \param r The parent reference holding the bit.
  /// \param bit The index of the bit within the parent reference.
  ...
  ///
  /// \param b The value to store in the referenced bit.
  /// \returns A reference to this BitReference.
