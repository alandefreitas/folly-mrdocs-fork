...
struct policy_size_type {
  /// The size_type selected by this policy.
...
struct policy_in_situ_only {
  /// Whether the small_vector is restricted to in-situ storage.
...
class small_vector
 ...
 public:
  ...
  /// The allocator type (provided for std::vector compatibility).
  ...
  /// Signed integer type for the difference between two iterators.
  ...
  /// Construct an empty small_vector.
  small_vector() = default;
  /// Allocator is unused here. It is taken in for compatibility with std::vector
  /// interface, but it will be ignored.
  ///
  /// \param alloc The allocator, which is ignored.
  small_vector(const std::allocator<Value>& alloc) {}

  /// Copy-construct from another small_vector.
  ///
  /// \param o The small_vector to copy from.
  ...
  /// Move-construct from another small_vector.
  ///
  /// \param o The small_vector to move from.
  ...
  ///
  /// \param il The initializer list of elements to copy.
  ...
  /// Construct with `n` copies of a given value.
  ///
  /// \param n The number of elements.
  /// \param t The value to copy into each element.
  ...
  /// Construct from an iterator range or from a (count, value) pair.
  ///
  /// \param arg1 The begin iterator, or the element count.
  /// \param arg2 The end iterator, or the value to fill with.
  template <class Arg>
  ...
  /// Destroy the small_vector and free any heap storage.
  ~small_vector() { destroy(); }

  /// Copy-assign the contents of another small_vector.
  ///
  /// \param o The small_vector to copy from.
  /// \returns A reference to this small_vector.
  ...
  /// Move-assign the contents of another small_vector.
  ///
  /// \param o The small_vector to move from.
  /// \returns A reference to this small_vector.
  ...
  /// Test two small_vectors for equality.
  ///
  /// \param o The small_vector to compare with.
  /// \returns `true` if both vectors have equal size and equal elements.
  bool operator==(small_vector const& o) const {
    return size() == o.size() && std::equal(begin(), end(), o.begin());
  }

  /// Compare two small_vectors lexicographically.
  ///
  /// \param o The small_vector to compare with.
  /// \returns `true` if this vector is lexicographically less than `o`.
  bool operator<(small_vector const& o) const {
  ...
  ///
  /// \param lhs The left-hand small_vector.
  /// \param rhs The right-hand small_vector.
  /// \returns The result of the lexicographical three-way comparison.
  ...
  ///
  /// \returns A const reverse iterator to the beginning of the reversed range.
  ...
  ///
  /// \returns A const reverse iterator to the end of the reversed range.
  ...
  /// Swap the contents of this small_vector with another.
  ///
  ...
  ///
  /// \param o The small_vector to swap with.
  ...
  /// Change the number of elements, value-initializing any new elements.
  ///
  ...
  /// Change the number of elements, copying a value into any new elements.
  ///
  /// \param sz The new size.
  /// \param v The value to copy into new elements.
  ...
  ///
  /// \param p Iterator to the position to insert before.
  ...
  /// Ensure capacity for at least `sz` elements.
  ///
  /// \param sz The minimum capacity to reserve.
  ...
  ///
  /// \returns The heap allocation size in bytes, or 0 when stored inline.
  ...
  /// Reduce heap capacity to fit the current size where possible.
  void shrink_to_fit() {
  ...
  /// Construct a new element in place at the end.
  ///
  /// \param args Arguments forwarded to the element's constructor.
  ...
  /// Insert a value before a position by moving it.
  ///
  /// \param constp Iterator to the position to insert before.
  /// \param t The value to move.
  ...
  /// Insert a copy of a value before a position.
  ///
  /// \param p Iterator to the position to insert before.
  /// \param t The value to copy.
  /// \returns An iterator to the inserted element.
  ...
  /// Insert `n` copies of a value before a position.
  ///
  ...
  /// Insert a range of elements before a position.
  ///
  /// \param p Iterator to the position to insert before.
  /// \param arg1 The begin iterator of the range, or the element count.
  /// \param arg2 The end iterator of the range, or the value to fill with.
  /// \returns An iterator to the first inserted element.
  template <class Arg>
  ...
  /// Insert the elements of an initializer list before a position.
  ///
  /// \param p Iterator to the position to insert before.
  /// \param il The initializer list of elements to insert.
  /// \returns An iterator to the first inserted element.
  ...
  ///
  /// \param q Iterator to the element to remove.
  /// \returns An iterator to the element that followed the removed element.
  ...
  /// Remove the elements in the range [q1, q2).
  ///
  /// \param q1 Iterator to the first element to remove.
  /// \param q2 Iterator past the last element to remove.
  /// \returns An iterator to the element that followed the removed range.
  ...
  /// Remove all elements, leaving the vector empty.
  void clear() {
  ...
  /// Replace the contents with the elements in an iterator range.
  ///
  ...
  /// Replace the contents with the elements of an initializer list.
  ///
  /// \param il The initializer list of elements to copy.
  ...
  /// Replace the contents with `n` copies of a value.
  ///
  /// \param n The number of elements.
  /// \param t The value to copy into each element.
...
///
/// \param a The first small_vector.
/// \param b The second small_vector.
template <class T, std::size_t MaxInline, class P>
void swap(small_vector<T, MaxInline, P>& a, small_vector<T, MaxInline, P>& b) {
  a.swap(b);
}

/// Remove all elements equal to a value from a small_vector.
///
/// \param v The small_vector to modify.
...
/// Remove all elements satisfying a predicate from a small_vector.
///
/// \param v The small_vector to modify.
/// \param predicate The predicate selecting elements to remove.
...
/// Standard library customization points for folly::small_vector.
namespace std {
...
struct hash<folly::small_vector<T, M, P>> {
  ...
  ///
  /// \param v The small_vector to hash.
  /// \returns The combined hash of the vector's elements.
