...
/// \param ptr The pointer to dereference, which may be null.
/// \returns A const reference to `*ptr`, or to a default-constructed value.
template <typename T>
...
/// value_or({}) would make.
/// \param optRef The optional-like object to read from.
/// \returns A const reference to the contained value, or to a
