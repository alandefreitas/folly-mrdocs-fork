...
/// Per-translation-unit tag type used to keep template instantiations unique.
...
///
/// Grows a `std::basic_string`, `std::vector`, or any container exposing
/// `resize_without_initialization()` without constructing or zeroing the new
/// elements. Reading an element added by this call before it has been written
/// to is undefined behavior. See the warning at the top of this header.
