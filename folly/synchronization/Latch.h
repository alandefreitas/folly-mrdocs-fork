...
class Latch {
 public:
  ...
  ///
  /// \returns The largest counter value a latch may be initialized with.
  ...
  ///
  /// \param expected The initial value of the counter.
  ...
  /// caller.
  ///
  /// \param n The amount to subtract from the counter.
  ...
  /// does not block.
  ///
  /// \returns true if the internal counter has reached zero, otherwise false.
  ...
  /// \returns true if the counter reached zero before the timeout, otherwise
  /// false.
  ...
  /// \returns true if the counter reached zero before the deadline, otherwise
  /// false.
  ...
  /// followed by a `wait()`.
  ///
  /// \param n The amount to subtract from the counter before waiting.
