...
/// Function object type implementing the lightweight asymmetric fence.
///
...
/// The lightweight asymmetric thread fence callable.
inline constexpr asymmetric_thread_fence_light_fn
    asymmetric_thread_fence_light{};

/// Function object type implementing the heavyweight asymmetric fence.
///
...
/// The heavyweight asymmetric thread fence callable.
...
struct asymmetric_thread_fence_traits<std::atomic> {
  /// The lightweight asymmetric fence callable for std::atomic.
  static inline constexpr asymmetric_thread_fence_light_fn light{};
  /// The heavyweight asymmetric fence callable for std::atomic.
