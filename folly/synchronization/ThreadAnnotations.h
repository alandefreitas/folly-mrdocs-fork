...
class FOLLY_TS_CAPABILITY("mutex") AnnotatedMutex {
 public:
  ...
  AnnotatedMutex(const AnnotatedMutex& other) = delete;
  /// Deleted copy assignment; the mutex is not copyable.
  AnnotatedMutex& operator=(const AnnotatedMutex& other) = delete;
  /// Deleted move constructor; the mutex is not movable.
  AnnotatedMutex(AnnotatedMutex&& other) = delete;
  /// Deleted move assignment; the mutex is not movable.
  AnnotatedMutex& operator=(AnnotatedMutex&& other) = delete;
  ...
  /// Returns the mutex itself to express negative capabilities.
  ///
  /// Enables FOLLY_TS_REQUIRES(!mu) syntax for negative capabilities.
  ///
  /// \returns A reference to this mutex.
...
class FOLLY_TS_SCOPED_CAPABILITY AnnotatedLockGuard {
 public:
  ...
  AnnotatedLockGuard(const AnnotatedLockGuard& other) = delete;
  /// Deleted copy assignment; the guard is not copyable.
  AnnotatedLockGuard& operator=(const AnnotatedLockGuard& other) = delete;
  /// Deleted move constructor; the guard is not movable.
  AnnotatedLockGuard(AnnotatedLockGuard&& other) = delete;
  /// Deleted move assignment; the guard is not movable.
  AnnotatedLockGuard& operator=(AnnotatedLockGuard&& other) = delete;
