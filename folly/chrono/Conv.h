 ...
 * \returns The converted duration, or an error code.
 */
 ...
 *
 * \param value The POSIX time value to convert.
 * \returns The converted time point, or an error code.
 */
template <typename Tgt, typename Src>
typename std::enable_if<
 ...
 * \returns The converted timespec, or an error code.
 */
 ...
 *
 * \param duration The duration to convert.
 * \returns The converted timeval, or an error code.
 */
template <typename Tgt, typename Rep, typename Period>
typename std::enable_if<
 ...
 * \returns The converted POSIX time value, or an error code.
 */
 ...
 * \returns The converted target value, throwing on conversion error.
 */
template <typename Tgt, typename Src>
