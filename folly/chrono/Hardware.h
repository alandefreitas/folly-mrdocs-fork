...
///
/// \returns The current hardware timestamp counter reading.
...
///
/// \returns A hardware timestamp taken at the start of a measurement.
...
///
/// \returns A hardware timestamp taken at the end of a measurement.
