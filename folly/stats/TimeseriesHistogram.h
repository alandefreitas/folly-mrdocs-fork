...
class TimeseriesHistogram {
 ...
 public:
   ...
   *
   * \param bucketIdx The index of the bucket to query.
   * \returns The lower threshold of the given bucket.
   */
  ...
  ///
  /// \param bucketIdx The index of the bucket to return.
  /// \returns The timeseries stored in the given bucket.
  ...
  ///
  /// \param level The timeseries level to query.
  /// \returns The total count of values at the given level.
  ...
  /// \returns The total count of values added during the interval.
  ...
  ///
  /// \param level The timeseries level to query.
  /// \returns The total sum of values at the given level.
  ...
  /// \param start The inclusive start of the interval.
  /// \param end The exclusive end of the interval.
  /// \returns The total sum of values added during the interval.
  ...
  ///
  /// \param level The timeseries level to query.
  /// \returns The average of values at the given level.
  ...
  /// \param start The inclusive start of the interval.
  /// \param end The exclusive end of the interval.
  /// \returns The average of values added during the interval.
  template <typename ReturnType = double>
   ...
   *
   * \param level The timeseries level to query.
   * \returns The sum of all values at the level divided by the elapsed time.
   */
  template <typename ReturnType = double>
   ...
   * \param start The inclusive start of the interval.
   * \param end The exclusive end of the interval.
   * \returns The sum of all values divided by the interval length.
   */
  template <typename ReturnType = double>
   ...
   *
   * \param now The time to update all underlying timeseries to.
   */
   ...
   *
   * \param now The time to add the values at.
   * \param values The histogram whose values are added.
   */
   ...
   *
   * \param pct The percentile to estimate.
   * \param level The timeseries level to query.
   ...
   *
   * \param pct The percentile to estimate.
   * \param start The inclusive start of the historical interval.
   * \param end The exclusive end of the historical interval.
   * \returns The estimated value at the given percentile.
   */
   ...
   *
   * \param pct The percentile to look up.
   * \param level The timeseries level to query.
   * \returns The index of the bucket the percentile falls into.
   */
   ...
   * \param pct The percentile to look up.
   * \param level The timeseries level to query.
   * \returns The threshold of the bucket containing the given percentile.
   */
   ...
   *
   * \param level The timeseries level to serialize.
   * \returns The serialized bucket data for the level.
   */
   ...
   * \param start The inclusive start of the historical interval.
   * \param end The exclusive end of the historical interval.
   * \returns The serialized bucket data for the interval.
   */
  ...
  /// Add a value into the histogram at the given time, relative to the clock epoch.
  ///
  ...
  /// Add a value the given number of times at the given time, relative to the clock epoch.
  ///
  /// \param now The time, relative to the clock epoch, to add the value at.
  /// \param value The value to add.
  /// \param times The number of times to add the value.
  ...
  /// Add all values from the given histogram at the given time, relative to the clock epoch.
  ///
  /// \param now The time, relative to the clock epoch, to add the values at.
  /// \param values The histogram whose values are added.
