...
struct Validator {
   ...
   *
   * \param value The dynamic to validate against the schema.
   */
   ...
   *
   * \param value The dynamic to validate against the schema.
   * \returns An empty exception_wrapper on success, or one describing the
   * failure.
   */
 ...
 *
 * \param schema The schema to validate values against.
 * \returns A validator that checks values against the given schema.
 */
 ...
 *
 * \returns A validator that checks whether a schema is itself valid.
 */
