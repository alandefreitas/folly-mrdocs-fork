...
/// @param awaitable The operation to await.
/// @param duration The maximum time to wait before timing out.
/// @returns A task with the awaitable's result, or `folly::none` on timeout.
