...
///  }
///
/// \param head The first generator to consume.
/// \param tail The remaining generators, consumed in order after `head`.
/// \returns A single generator yielding the values of every input generator.
template <
    typename HReference,
    typename... TReference,
    typename HValue,
