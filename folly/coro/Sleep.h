...
/// @param tk the timekeeper to schedule the sleep on, or null for the default
/// @returns a Task that completes after the duration elapses
...
/// @param d the duration to sleep for
/// @param tk the timekeeper to schedule the sleep on, or null for the default
/// @returns a Task that completes after the duration elapses or on cancellation
