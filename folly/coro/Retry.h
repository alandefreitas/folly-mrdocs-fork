...
/// @param func Callable returning the awaitable operation to run.
/// @param retryDelay Callable invoked with each error, returning an awaitable delay before retrying.
/// @returns A task producing the operation's result.
...
/// @param func Callable returning the awaitable operation to run.
/// @param decider Callable deciding, per error, whether to retry.
/// @returns A task producing the operation's result.
...
/// Executes the operation returned by func(), retrying it up to 'maxRetries'
/// times on any failure with no delay between retries.
/// @param maxRetries Maximum number of retries before giving up.
/// @param func Callable returning the awaitable operation to run.
/// @returns A task producing the operation's result.
...
/// not.
/// @param maxRetries Maximum number of retries before giving up.
/// @param minBackoff Minimum backoff delay for the first retry.
/// @param maxBackoff Maximum backoff delay any retry may wait.
/// @param relativeJitterStdDev Standard deviation of the jitter relative to the backoff.
/// @param timeKeeper Timekeeper used to schedule the backoff delays.
/// @param rng Random number generator used to compute the jitter.
/// @param func Callable returning the awaitable operation to run.
/// @param decider Callable deciding, per error, whether to retry.
/// @returns A task producing the operation's result.
...
/// Retries `func()` with exponential backoff, always retrying, using the given
/// timekeeper and random generator.
/// @param maxRetries Maximum number of retries before giving up.
/// @param minBackoff Minimum backoff delay for the first retry.
/// @param maxBackoff Maximum backoff delay any retry may wait.
/// @param relativeJitterStdDev Standard deviation of the jitter relative to the backoff.
...
/// Retries `func()` with exponential backoff, always retrying, using the given
/// timekeeper and the default random generator.
/// @param maxRetries Maximum number of retries before giving up.
/// @param minBackoff Minimum backoff delay for the first retry.
/// @param maxBackoff Maximum backoff delay any retry may wait.
/// @param relativeJitterStdDev Standard deviation of the jitter relative to the backoff.
...
/// Retries `func()` with exponential backoff, always retrying, using the
/// default timekeeper and random generator.
/// @param maxRetries Maximum number of retries before giving up.
/// @param minBackoff Minimum backoff delay for the first retry.
/// @param maxBackoff Maximum backoff delay any retry may wait.
/// @param relativeJitterStdDev Standard deviation of the jitter relative to the backoff.
...
/// Retries `func()` with exponential backoff, using the default timekeeper and
/// random generator, consulting `decider` on each error.
/// @param maxRetries Maximum number of retries before giving up.
/// @param minBackoff Minimum backoff delay for the first retry.
/// @param maxBackoff Maximum backoff delay any retry may wait.
/// @param relativeJitterStdDev Standard deviation of the jitter relative to the backoff.
