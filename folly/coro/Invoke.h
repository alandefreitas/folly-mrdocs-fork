...
struct co_invoke_fn {
  /// Invokes the callable with the given arguments and awaits the result.
  ///
  /// @param f the callable to invoke
  /// @param a the arguments to forward to the callable
  /// @returns the awaitable produced by invoking the callable
...
/// CPO that invokes a callable and awaits its coroutine result.
///
