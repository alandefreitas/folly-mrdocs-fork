...
///
/// @param awaitable the awaitable to run
/// @returns a `result<T>` in a value or error state, never stopped
template <typename Awaitable>
...
///
/// @param awaitable the awaitable to run
/// @returns a `result<T>` that may also report a stopped completion
template <typename Awaitable>
