...
///
/// @param executor the executor on which to run the merge
/// @param sources a stream of input generators to merge
/// @returns a generator that yields values from all input streams
