...
///
/// \param awaitables The awaitables to await concurrently.
/// \returns A SemiAwaitable completing with a std::tuple of the results.
template <typename... SemiAwaitables>
...
//    }
//
/// Concurrently await multiple awaitables and complete with a tuple of Try
/// results.
///
/// \param awaitables The awaitables to await concurrently.
/// \returns A SemiAwaitable completing with a std::tuple of Try<T> results.
template <typename... SemiAwaitables>
...
///
/// \param awaitables The range of awaitables to await.
/// \returns A Task completing with a vector of the results in input order.
template <
    typename InputRange,
    std::enable_if_t<
        !std::is_void_v<
...
///
/// \param awaitables The range of awaitables to await.
/// \returns A Task that completes when every awaitable has finished.
template <
    typename InputRange,
    std::enable_if_t<
        std::is_void_v<
...
/// Concurrently await a range of awaitables and collect a vector of Try
/// results.
///
/// \param awaitables The range of awaitables to await.
/// \returns A Task completing with a vector of Try<T> results in input order.
...
///
/// \param awaitables The vector of awaitables to await.
/// \returns A Task completing with a vector of the results in input order.
template <typename SemiAwaitable>
...
/// Await an rvalue vector of awaitables, collecting a vector of Try results.
///
/// \param awaitables The vector of awaitables to await.
/// \returns A Task completing with a vector of Try<T> results in input order.
template <typename SemiAwaitable>
...
///
/// \param scope The AsyncScope the awaitables are attached to.
/// \param awaitables The range of awaitables to run.
/// \returns An AsyncGenerator yielding each result as it completes.
template <typename InputRange>
...
/// \param scope The AsyncScope the awaitables are attached to.
/// \param awaitables The range of awaitables to run.
/// \returns An AsyncGenerator yielding each Try result as it completes.
template <typename InputRange>
...
///
/// \param scope The AsyncScope the awaitables are attached to.
/// \param awaitables The vector of awaitables to run.
/// \returns An AsyncGenerator yielding each result as it completes.
template <typename SemiAwaitable>
...
/// Yield the results of a range of awaitables in order of completion.
///
/// \param scope The CancellableAsyncScope the awaitables are attached to.
/// \param awaitables The range of awaitables to run.
/// \returns An AsyncGenerator yielding each result as it completes.
template <typename InputRange>
auto makeUnorderedAsyncGenerator(
...
///
/// \param awaitables The range of awaitables to await.
/// \param maxConcurrency The maximum number of awaitables awaited at once.
/// \returns A Task that completes when every awaitable has finished.
template <
    typename InputRange,
    std::enable_if_t<
...
/// Await a range of awaitables with bounded concurrency, collecting Try
/// results.
///
/// \param awaitables The range of awaitables to await.
/// \param maxConcurrency The maximum number of awaitables awaited at once.
...
/// Await an rvalue vector of awaitables with bounded concurrency, collecting
/// Try results.
///
/// \param awaitables The vector of awaitables to await.
/// \param maxConcurrency The maximum number of awaitables awaited at once.
...
///
/// \param awaitable The first awaitable to await.
/// \param awaitables The remaining awaitables to await.
/// \returns A Task with a pair of the winning index and its Try value.
...
///
/// \param awaitables The awaitables to await.
/// \returns A Task with a pair of the winning index and its Try value.
template <typename... SemiAwaitables>
...
///
/// \param awaitables The awaitables to await.
/// \returns A Task with a tuple of Try results for all awaitables.
template <typename... SemiAwaitables>
...
//       ranges::views::move);
//
/// Concurrently await a range of awaitables and return the first result and
/// index.
///
/// \param awaitables The range of awaitables to await.
/// \returns A Task with a pair of the winning index and its Try value.
...
///
/// \param awaitables The range of awaitables to await.
/// \returns A Task with a vector of Try results for all awaitables.
template <typename InputRange>
...
// std::vector<T>::reference type is T& rather than T&& and some awaitables,
// such as Task<U>, are not lvalue awaitable.
/// Await an rvalue vector of awaitables and return the first result and index.
///
/// \param awaitables The vector of awaitables to await.
/// \returns A Task with a pair of the winning index and its Try value.
template <typename SemiAwaitable>
...
/// Await an rvalue vector of awaitables, returning the first success or last
/// error.
///
/// \param awaitables The vector of awaitables to await.
/// \returns A Task with a pair of the winning index and its Try value.
...
/// Await an rvalue vector of awaitables and return every result once one
/// finishes.
///
/// \param awaitables The vector of awaitables to await.
/// \returns A Task with a vector of Try results for all awaitables.
