...
///
/// @param source the input stream of values
/// @param filterFn the predicate selecting which values to keep
/// @returns a stream of the values that satisfy the predicate
