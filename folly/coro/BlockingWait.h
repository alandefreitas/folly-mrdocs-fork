...
struct blocking_wait_fn {
  /// Blocks the current thread until the awaitable completes.
  ///
  /// @param awaitable The awaitable to wait on.
  /// @returns The result produced by the awaitable.
  template <typename Awaitable>
  ...
  /// Blocks the current thread until the semi-awaitable completes on the given
  /// executor.
  ///
  /// @param awaitable The semi-awaitable to wait on.
  /// @param executor The executor that drives the semi-awaitable.
  /// @returns The result produced by the semi-awaitable.
  ...
  /// Blocks the current thread until the must-use-immediately semi-awaitable
  /// completes on the given executor.
  ///
  /// @param awaitable The semi-awaitable to wait on.
  /// @param executor The executor that drives the semi-awaitable.
  /// @returns The result produced by the semi-awaitable.
  ...
  /// Blocks the current thread until the semi-awaitable completes on an
  /// internal executor.
  ///
  /// @param awaitable The semi-awaitable to wait on.
  /// @returns The result produced by the semi-awaitable.
  ...
  /// Blocks the current thread until the must-use-immediately semi-awaitable
  /// completes on an internal executor.
  ///
  /// @param awaitable The semi-awaitable to wait on.
  /// @returns The result produced by the semi-awaitable.
  template <typename SemiAwaitable>
...
/// Awaits the passed awaitable and blocks the current thread until it completes.
