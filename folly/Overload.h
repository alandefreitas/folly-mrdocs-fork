 ...
 * supported).
 *
 * \param cases The case objects to combine into one overload set.
 * \returns A function object dispatching to the matching case.
 */
...
/// Implementation-detail invokers used by `variant_match`.
namespace overload_detail {
/// Invoker for the member `valueless_by_exception`.
...
/// Invoker for unqualified `visit`.
/// \implementationdefined
FOLLY_CREATE_FREE_INVOKER(visit, visit);
/// Invoker for unqualified `apply_visitor`.
/// \implementationdefined
 ...
 * \param cases The cases to match the variant with.
 * \returns The result of invoking the matching case.
 */
 ...
 * \param variant The variant to match against.
 * \param cases The cases to match the variant with.
 * \returns The result of invoking the matching case, as type `R`.
 */
