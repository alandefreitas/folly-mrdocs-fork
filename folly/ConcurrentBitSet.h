...
class ConcurrentBitSet {
 public:
  ...
  /// Copy construction is deleted; the bitset is not copyable.
  ///
  /// \param other The bitset that would be copied from.
  ConcurrentBitSet(const ConcurrentBitSet& other) = delete;
  /// Copy assignment is deleted; the bitset is not copyable.
  ///
  /// \param other The bitset that would be assigned from.
  /// \returns A reference to this bitset.
  ConcurrentBitSet& operator=(const ConcurrentBitSet& other) = delete;
   ...
   * \param order The memory order used for the read-modify-write operation.
   ...
   * \param order The memory order used for the read.
