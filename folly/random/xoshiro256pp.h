...
class xoshiro256pp {
 ...
 public:
  ...
  /// Constructs the generator seeded from a scalar value.
  ///
  /// \param value The seed value.
  xoshiro256pp(result_type value = default_seed) noexcept { seed(value); }

  /// Constructs the generator seeded from a seed sequence.
  ///
 ...
 private:
  ...
  union {
    /// Vectorized results buffer.
    vector_type vecRes[VecResCount]{};
    /// Scalar view of the results buffer.
  ...
  /// Writes the generator's internal state to an output stream.
  ///
  /// \param os The output stream.
  /// \param rng The generator to write.
