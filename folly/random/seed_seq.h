...
struct seed_seq_generate_fn {
 ...
 public:
  ...
  ///
  /// \param dst The destination state buffer to fill.
  /// \param seq The seed sequence to generate data from.
...
/// Callable object that fills a state buffer from a seed sequence.
...
struct make_std_seed_seq_fn {
  ...
  ///
  /// \param word The seed value.
  /// \returns A std::seed_seq initialized from the seed value.
...
/// Callable object that builds a std::seed_seq from a seed value.
