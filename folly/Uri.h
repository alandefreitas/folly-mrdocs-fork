...
enum class UriFormatError {
  INVALID_URI, ///< The URI could not be parsed.
  INVALID_URI_AUTHORITY, ///< The authority component is malformed.
  INVALID_URI_PORT, ///< The port component is malformed.
};
...
class Uri {
 public:
   ...
   *
   * @return The host component, with square brackets for IPv6 addresses.
   */
   ...
   *
   * @return The host component, without square brackets for IPv6 addresses.
   */
  ...
  ///
  /// \returns The reassembled URI as the requested string type.
  template <class String>
  String toString() const;

  /// Reassemble the URI into a std::string.
  ///
  /// \returns The reassembled URI as a std::string.
  std::string str() const { return toString<std::string>(); }
  /// Reassemble the URI into an fbstring.
  ///
  /// \returns The reassembled URI as an fbstring.
