 ...
 *       caller thread.
 *
 * \param pred The predicate applied to each value in parallel.
 * \param nThreads The number of worker threads to use; 0 selects a default.
 * \returns An operator that maps each value using `pred` across threads.
 */
