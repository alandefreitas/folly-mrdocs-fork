 ...
 * @methodset fnv
 *
 * @param hash Running FNV hash value to update
 * @param c Byte to fold into the hash
 * @return The updated FNV hash value
 */
 ...
 * @methodset fnv
 *
 * @param buf Pointer to the bytes to hash
 * @param n Number of bytes to hash
 * @return The resulting FNV hash value
 */
 ...
 * @param buf Pointer to the bytes to hash
 * @param n Number of bytes to hash
 * @param hash Initial hash seed to continue from
 * @return The resulting FNV hash value
 */
 ...
 * @methodset fnv
 *
 * @param buf Null-terminated C string to hash
 * @return The resulting FNV hash value
 */
 ...
 * @methodset fnv
 *
 * @param str String whose bytes are hashed
 * @return The resulting FNV hash value
 */
