...
class IPAddress {
 ...
 public:
   ...
   *
   * @param ip The candidate string to check.
   * @return true if `ip` can be parsed as an IP address.
   */
   ...
   * @return The IPAddressV4 representation of `addr`.
   */
   ...
   *
   * @param addr The address to convert.
   * @return The IPAddressV6 representation of `addr`.
   */
   ...
   *
   * @param ipSlashCidr IP/CIDR formatted string to split.
   * @param defaultCidr Default value if no /N is specified (if -1, uses /32 for
   *        IPv4 and /128 for IPv6).
   * @param mask Whether to apply the mask on the address,
   *        e.g. 192.168.13.46/24 => 192.168.13.0/24.
   ...
   *
   * @param bytes The binary address data in network byte order.
   * @return An IPAddress built from `bytes`.
   */
   ...
   *
   * @param bytes The binary address data in network byte order.
   * @return The parsed IPAddress, or an IPAddressFormatError on failure.
   */
   ...
   * On failure, returns IPAddressFormatError.
   *
   * @param addr The socket address to read from.
   * @return The parsed IPAddress, or an IPAddressFormatError on failure.
   */
   ...
   * address.
   *
   * @param src The address value in network byte order.
   * @return The IPAddress built from `src`.
   */
   ...
   * address.
   *
   * @param src The address value in host byte order.
   * @return The IPAddress built from `src`.
   */
   ...
   * @return The longest common (address, mask) pair.
   */
   ...
   *
   * @param ipV4Addr The IPv4 address to wrap.
   */
   ...
   *
   * @param addr The `in_addr` value to wrap.
   */
   ...
   *
   * @param ipV6Addr The IPv6 address to wrap.
   */
   ...
   *
   * @param addr The `in6_addr` value to wrap.
   */
   ...
   *
   * @param ipv4_addr The IPv4 address to assign.
   ...
   *
   * @param ipv6_addr The IPv6 address to assign.
   * @return A reference to this IPAddress.
   */
   ...
   * a valid V4 instance.
   *
   * @return A reference to the underlying IPAddressV4 instance.
   */
   ...
   * a valid V6 instance.
   *
   * @return A reference to the underlying IPAddressV6 instance.
   */
   ...
   *
   * @return The address family (`AF_INET`, `AF_INET6`, or `AF_UNSPEC`).
   */
   ...
   *
   * Throws `IPAddressFormatException` if there is no /mask in cidrNetwork.
   */
   ...
   *
   * @return true if the address is a V4-mapped V6 address.
   */
   ...
   *
   * @return true if the address is uninitialised.
   */
   ...
   *
   * @return true if the address is initialised.
   */
   ...
   *
   * @return true if every bit of the address is zero.
   */
  bool isZero() const {
   ...
   *
   * @return The number of bits in the address representation.
   */
   ...
   *
   * @return The number of bytes in the address representation.
   */
   ...
   * @param bitIndex n
   * @return The value of the nth most significant bit.
   */
   ...
   * @param byteIndex n
   * @return The value of the nth most significant byte.
   */
   ...
   * @param bitIndex n
   * @return The value of the nth least significant bit.
   */
   ...
   * @param byteIndex n
   * @return The value of the nth least significant byte.
   */
   ...
   *
   * @return A JSON object string describing the address.
   */
  std::string toJson() const {
   ...
   *
   * @return true if the address is a link-local broadcast address.
   */
  bool isLinkLocalBroadcast() const {
   ...
   * 2000::/3, ffxe::/16.
   *
   * @return true if the address is non-routable.
   */
  bool isNonroutable() const {
   ...
   *
   * @return The address version: 0 if empty, 4 or 6 otherwise.
   */
   ...
   *
   * @return A pointer to the address bytes in network byte order.
   */
 ...
 * @param result The string to append the address representation to.
 */
void toAppend(IPAddress addr, std::string* result);
/**
 * Append a string representation of the IP address to an fbstring.
 *
 * @param addr The address to append.
 * @param result The string to append the address representation to.
 */
 ...
 * @param addr1 The first address to compare.
 * @param addr2 The second address to compare.
 * @return The ordering of `addr1` relative to `addr2`.
 */
