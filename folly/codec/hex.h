...
///
/// \param v The decoded digit value to validate.
/// \returns True if the decoded digit is valid.
...
/// hex_is_digit_table
///
/// \param h The character to decode.
/// \returns True if `h` is a hex digit character.
...
///
/// \param h The character to decode.
/// \returns The decoded value of `h`.
