 ...
 *
 * \param signals The set of fatal signals to install the handler for.
 */
...
///
/// \param cb The async-signal-safe callback to add.
 ...
 *
 * \returns true if a fatal signal has been received.
 */
