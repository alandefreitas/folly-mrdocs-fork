...
struct ExceptionInfo {
  /// The dynamic type of the exception, or nullptr if unknown.
  const std::type_info* type{nullptr};
  /// The instruction-pointer addresses of the captured stack trace.
  ///
  /// front() is the top of the stack. They are only filled if the low-level
  /// exception tracer library is linked in or LD_PRELOADed.
