...
///
/// \param name Pointer to the literal's characters, used as the format string.
/// \param length Length of the literal in characters.
/// \returns A `ShellCmdFormat` bound to the given format string.
 ...
 *
 * @param format Format string describing the command.
 * @param arguments Arguments substituted into the format string after quoting.
 * @returns The argument array to pass to `Subprocess()`.
 */
// clang-format off
template <typename... Arguments>
[[deprecated(
