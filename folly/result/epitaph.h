...
///
/// \param eos The error-or-stopped state to annotate.
/// \param snl The format string and captured source location.
/// \param args Format arguments for the annotation message.
/// \returns The annotated error-or-stopped state.
...
/// Annotates the error state of a `result<T>` with an epitaph message.
///
/// Value inputs are returned unchanged.
///
/// \param r The result to annotate.
/// \param snl The format string and captured source location.
/// \param args Format arguments for the annotation message.
/// \returns The result, with its error state annotated when present.
...
/// \param snl The format string and captured source location.
/// \param args Format arguments for the annotation message.
/// \returns The error-or-stopped state annotated with a stack-trace epitaph.
template <
