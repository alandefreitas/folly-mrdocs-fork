...
/// Deduction guide: an rvalue `result<T>` yields `or_unwind<result<T>&&>`.
template <typename T>
...
/// Deduction guide: an lvalue `result<T>` yields `or_unwind<result<T>&>`.
template <typename T>
or_unwind(result<T>&) -> or_unwind<result<T>&>;
...
/// Deduction guide: a `const result<T>&` yields `or_unwind<const result<T>&>`.
template <typename T>
...
/// Deduction guide: a `result<T>` yields `or_unwind_owning<result<T>>`.
template <typename T>
...
/// Deduction guide: an rvalue `error_or_stopped` yields `or_unwind<error_or_stopped&&>`.
...
/// Deduction guide: an `error_or_stopped` yields `or_unwind_owning<error_or_stopped>`.
or_unwind_owning(error_or_stopped) -> or_unwind_owning<error_or_stopped>;
/// Deduction guide: a `stopped_result` yields `or_unwind_owning<error_or_stopped>`.
...
/// Owning awaitable for `or_unwind(stopped_result)`.
template <>
class [[nodiscard]] or_unwind<error_or_stopped> final
    : public detail::result_or_unwind<error_or_stopped> {
  using detail::result_or_unwind<error_or_stopped>::result_or_unwind;
};
/// Deduction guide: a `stopped_result` yields `or_unwind<error_or_stopped>`.
