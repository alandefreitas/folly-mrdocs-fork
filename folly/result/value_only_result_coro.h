...
/// Deduction guide for `or_unwind` from an rvalue `value_only_result`.
template <typename T>
...
/// Deduction guide for `or_unwind` from an lvalue `value_only_result`.
template <typename T>
or_unwind(value_only_result<T>&) -> or_unwind<value_only_result<T>&>;
...
/// Deduction guide for `or_unwind` from a const lvalue `value_only_result`.
template <typename T>
...
/// Deduction guide for `or_unwind_owning` from a `value_only_result`.
template <typename T>
