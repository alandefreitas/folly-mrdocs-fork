...
/// A rich error representing a cancelled operation.
...
rich_exception_ptr final : public detail::rich_exception_ptr_base {
 ...
 public:
  /// Formats the exception into a `fmt` output iterator.
  ///
  /// \param out The output iterator to write the formatted text to.
  /// \param opts Options controlling how much rich detail to include.
  void format_to(
...
/// Writes a `rich_exception_ptr` to an output stream.
///
/// \param os The output stream to write to.
/// \param rep The exception pointer to format.
