...
class Barrier {
 public:
  /// Constructs a barrier that releases once `n` threads have waited.
  ///
  /// @param n the number of participants required to release the barrier
  ...
  ///
  /// @returns a future completing with true for exactly one waiter, false otherwise
