...
class HeapTimekeeper : public Timekeeper {
 public:
  ...
  ///
  /// @param dur The delay after which the returned future completes.
  /// @returns A SemiFuture that completes once the duration has elapsed.
  SemiFuture<Unit> after(HighResDuration dur) override;
