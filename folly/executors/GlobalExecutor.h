...
/// Thread count flag for the global CPU executor.
///
/// \implementationdefined
FOLLY_GFLAGS_DECLARE_uint32(folly_global_cpu_executor_threads);

/// Thread count flag for the global IO executor.
///
/// \implementationdefined
...
struct GlobalCPUExecutorCounters {
  ...
  size_t numThreads;
  /// Number of threads currently active (running but possibly waiting for
  /// tasks).
 ...
 *
 * @return Global mutable CPU executor.
 */
[[deprecated(
 ...
 *
 * @param executor Executor to set as the global mutable CPU executor.
 */
[[deprecated(
 ...
 *
 * @param executor IO Executor to set as the global mutable IO executor.
 */
[[deprecated(
 ...
 * there.
 *
 * @return Event base from the global mutable IO executor.
 */
[[deprecated(
