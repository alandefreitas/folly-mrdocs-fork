 ...
 public:
  ...
  class Options {
   public:
    ...
    /// Sets the interval.
    ///
    /// \param value The new interval duration.
    ...
    /// Returns the configured target delay.
    ///
    /// \returns The target delay duration.
    std::chrono::milliseconds targetDelay() const { return targetDelay_; }

    /// Sets the target delay.
    ///
    /// \param value The new target delay duration.
    /// \returns A reference to this Options instance.
  ...
  ///
  /// \param options The target delay and interval parameters to use.
  ...
  ///
  /// \param delay The queueing delay measured for this request.
  /// \returns True if this request should be expired to reduce overload.
  ...
  ///
  /// \param delay The queueing delay measured for this request.
  /// \param now The current time to evaluate the delay against.
  /// \returns True if this request should be expired to reduce overload.
  ...
  ///
  /// \returns The queue load as a percentage from 0 to 100.
  int getLoad();
  ...
  ///
  /// \param options The new target delay and interval parameters.
