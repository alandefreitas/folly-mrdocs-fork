...
class TimedDrivableExecutor : public DrivableExecutor {
 public:
  ...
  ///
  /// \param timeout Maximum duration to wait for work to be enqueued.
  /// \returns True if work was performed, false otherwise.
  ...
  ///
  /// \param deadline Time point to wait until for work to be enqueued.
  /// \returns True if work was performed, false otherwise.
  ...
  ///
  /// \param timeout Maximum duration to wait for work to become available.
  /// \returns True if there is work to do, false otherwise.
  template <typename Rep, typename Period>
  bool try_wait_for(
      const std::chrono::duration<Rep, Period>& timeout) noexcept {
  ...
  ///
  /// \param deadline Time point to wait until for work to become available.
  /// \returns True if there is work to do, false otherwise.
  template <typename Clock, typename Duration>
  bool try_wait_until(
      const std::chrono::time_point<Clock, Duration>& deadline) noexcept {
