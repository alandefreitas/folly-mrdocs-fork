...
class FiberIOExecutor : public IOExecutor {
 public:
  /// Constructs the executor from a backing IO executor.
  ///
  /// \param ioExecutor The IO executor whose event base backs this executor.
  /// \param opts Options used to configure the mapped fiber manager.
  ...
  /// Schedules a function to run on the mapped fiber manager.
  ///
  ...
  /// Returns the event base of the backing IO executor.
  ///
  /// \returns The underlying event base.
